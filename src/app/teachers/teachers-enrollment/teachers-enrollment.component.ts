...
export class TeachersEnrollmentComponent {
  ...
  openUpdateDialog(): void {
    const dialogRef = this.dialog.open(UpdateTeachersEnrollmentDialog, {
...
@Component({
  ...
  templateUrl: 'update-teachers-enrollment-dialog.html',
})
export class UpdateTeachersEnrollmentDialog {
  range = new FormGroup({
    start: new FormControl<Date | null>(null),
    end: new FormControl<Date | null>(null),
  });
  ...
  constructor(
    public dialogRef: MatDialogRef<UpdateTeachersEnrollmentDialog>,
